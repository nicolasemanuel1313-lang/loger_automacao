...
from extrair_loger_32 import extrair_base_loger
from salvar_excel import salvar_excel

# Carrega as variáveis do arquivo .env
load_dotenv()

centros = json.loads(os.getenv("LOGER_CENTROS_32", "{}"))

PASTA_DESTINO = os.getenv("PASTA_DESTINO_32")
PASTA_CAPA = os.getenv("PASTA_CAPA_32")
